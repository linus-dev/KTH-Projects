...
public class two_bst {
  public static class BST<Key extends Comparable<Key>, Value> {
    ...
    public Iterable<Key> levelOrder() {
        edu.princeton.cs.algs4.Queue<Key> keys = new edu.princeton.cs.algs4.Queue<Key>();
        edu.princeton.cs.algs4.Queue<Node> queue = new edu.princeton.cs.algs4.Queue<Node>();
        queue.enqueue(root);
        while (!queue.isEmpty()) {
