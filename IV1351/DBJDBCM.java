...
public class DBJDBCM
{
    ...
    // DB access variables
    private String URL = "jdbc:mysql:///lab_db";
    private String driver = "com.mysql.jdbc.Driver";
    private String userID = "root";
    private String password = "lkjhg1";
    ...
    public void simpleselect() throws Exception
    {
        ...
        System.out.println("Resultatet (Bilmärken):");
    ...
    public void parameterizedselect() throws Exception
    {
        ...
        // Set the SQL statement into the query variable
        query = "SELECT regnr, marke, farg FROM bil INNER JOIN person ON person.id=bil.agare WHERE person.stad=?";
        ...
        System.out.println("Resultatet (Bilar i staden " + stadparam + "):");
